...
python3 $PRJ_ROOT/auto_config_lib/shortcut_config/set_custom_shortcut.py RedShiftEnable "redshift -O 3000" "<Primary><Super>x"
python3 $PRJ_ROOT/auto_config_lib/shortcut_config/set_custom_shortcut.py RedShiftDisable "redshift -x" "<Primary><Super>z"